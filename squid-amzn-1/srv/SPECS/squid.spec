...
# Disabled libecap since I do not have a compiled version compatible for V4.
#Requires: libecap
## eCAP 1.0.0
...
# Required by couple external acl helpers in newer versions of the OS
...
# Libecap support removed since I do not have a compiled compatible version of it.
#  --enable-ecap \
